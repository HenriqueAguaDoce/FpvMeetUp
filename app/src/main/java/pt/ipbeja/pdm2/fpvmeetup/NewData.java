...
/**
 * Created by HenriqueAD on 08/01/2017.
 */
...
public class NewData {
    ...
    static String[] Articles = {
            "Article One\n\nExcepteur pour-over occaecat squid biodiesel umami gastropub, nulla " +
                    ...
                    "Esse single-origin coffee banksy do next level tempor. Velit synth d" +
                    "reamcatcher, magna shoreditch in american apparel messenger bag narwhal " +
                    "PBR ennui farm-to-table.",
